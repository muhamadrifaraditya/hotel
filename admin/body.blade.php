    ...
    <section class="no-padding-bottom">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="user-block block text-center">
                        <div class="avatar"><img src="{{ asset('admin/img/avatar-4.jpg') }}" alt="..."
                                class="img-fluid">
            ...
            <div class="public-user-block block">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-4 d-flex align-items-center">
                        ...
                        <div class="avatar"> <img src="{{ asset('admin/img/avatar-2.jpg') }}" alt="..."
                                class="img-fluid"></div><a href="#" class="name"><strong
                ...
                <div class="col-lg-6">
                    <div class="messages-block block">
                        ...
                        <div class="messages"><a href="#" class="message d-flex align-items-center">
                                <div class="profile"><img src="{{ asset('admin/img/avatar-3.jpg') }}" alt="..."
                                        class="img-fluid">
                                ...
                                <div class="profile"><img src="{{ asset('admin/img/avatar-2.jpg') }}" alt="..."
                                        class="img-fluid">
                                ...
                                <div class="profile"><img src="{{ asset('admin/img/avatar-1.jpg') }}" alt="..."
                                        class="img-fluid">
