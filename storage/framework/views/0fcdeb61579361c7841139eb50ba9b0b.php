            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="user-block block text-center">
                        <div class="avatar"><img src="<?php echo e(asset('admin/img/avatar-1.jpg')); ?>" alt="..."
                                class="img-fluid">
                ...
                <div class="col-lg-4">
                    <div class="user-block block text-center">
                        <div class="avatar"><img src="<?php echo e(asset('admin/img/avatar-4.jpg')); ?>" alt="..."
                                class="img-fluid">
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-lg-4 d-flex align-items-center">
                        ...
                        <div class="avatar"> <img src="<?php echo e(asset('admin/img/avatar-1.jpg')); ?>" alt="..."
                                ...
                                class="d-block">Tomas Hecktor</strong><span class="d-block">@tomhecktor</span></a>
                    </div>
            ...
            <div class="public-user-block block">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-4 d-flex align-items-center">
                        ...
                        <div class="avatar"> <img src="<?php echo e(asset('admin/img/avatar-2.jpg')); ?>" alt="..."
                                class="img-fluid"></div><a href="#" class="name"><strong
                                class="d-block">Alexander Shelby</strong><span class="d-block">@alexshelby</span></a>
                    </div>
                    <div class="col-lg-4 text-center">
            ...
            <div class="public-user-block block">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-4 d-flex align-items-center">
                        ...
                        <div class="avatar"> <img src="<?php echo e(asset('admin/img/avatar-6.jpg')); ?>" alt="..."
                                class="img-fluid"></div><a href="#" class="name"><strong
                                class="d-block">Arther Kooper</strong><span class="d-block">@artherkooper</span></a>
                    </div>
                    <div class="col-lg-4 text-center">
                        ...
                        <div class="row d-flex align-items-end justify-content-between">
                            <div class="col-4">
                                <div class="text"><strong class="d-block dashtext-1">$457</strong><span
                                        class="d-block">May 2017</span><small class="d-block">210 Sales</small></div>
                            </div>
                            <div class="col-8">
                                <div class="bar-chart chart">
                        ...
                        <div class="row d-flex align-items-end justify-content-between">
                            <div class="col-5">
                                <div class="text"><strong class="d-block dashtext-2">80%</strong><span
                                        class="d-block">May 2017</span><small class="d-block">+35 Sales</small></div>
                            </div>
                            <div class="col-7">
                                <div class="bar-chart chart">
                ...
                <div class="col-lg-6">
                    <div class="messages-block block">
                        ...
                        <div class="messages"><a href="#" class="message d-flex align-items-center">
                                <div class="profile"><img src="<?php echo e(asset('admin/img/avatar-3.jpg')); ?>" alt="..."
                                        class="img-fluid">
                                ...
                                <div class="profile"><img src="<?php echo e(asset('admin/img/avatar-2.jpg')); ?>" alt="..."
                                        class="img-fluid">
                                ...
                                <div class="profile"><img src="<?php echo e(asset('admin/img/avatar-1.jpg')); ?>" alt="..."
                                        class="img-fluid">
                                ...
                                <div class="profile"><img src="<?php echo e(asset('admin/img/avatar-5.jpg')); ?>" alt="..."
                                        class="img-fluid">
...
<?php /**PATH C:\xampp\htdocs\latihan\resources\views/admin/body.blade.php ENDPATH**/ ?>