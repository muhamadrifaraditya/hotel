        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="right-menu list-inline no-margin-bottom">
                ...
                <div class="list-inline-item dropdown"><a id="languages" rel="nofollow" data-target="#"
                        ...
                        class="nav-link language dropdown-toggle"><img src="{{ asset('admin/img/flags/16/GB.png') }}"
                    ...
                    <div aria-labelledby="languages" class="dropdown-menu"><a rel="nofollow" href="#"
                            class="dropdown-item"> <img src="{{ asset('admin/img/flags/16/DE.png') }}" alt="English"
                                class="mr-2"><span>German</span></a><a rel="nofollow" href="#"
                            class="dropdown-item"> <img src="{{ asset('admin/img/flags/16/FR.png') }}" alt="English"
